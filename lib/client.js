...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/** The active hotkey's label. Named without the substring "key" on
		 *  purpose: the security suite rejects any `setStatus(...)` text
		 *  containing "key" (it cannot tell a hotkey label from an API key),
		 *  so the status strings must not spell `hotkeyDisplay` out. */
